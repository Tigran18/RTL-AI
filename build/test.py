...
def main():
    ...
    activations = [ActivationType.Sigmoid] * 3  # same length as layer sizes
    net = Network([INPUT_SIZE, 40, 40, OUTPUT_SIZE], activations, 0.1, 20000, 32, 0.0)
    ...
    if os.path.exists(MODEL_FILE):
        ...
        net.train(inputs, targets, inputs, targets)
